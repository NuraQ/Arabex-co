...
function UpdateElement() {
  ...
  useEffect(() => {
    ...
    // if (location) setElement(location.state.element);
  }, []);
    ...
    <div class="row">
      <div class="form-style-5">
        <form>
          <fieldset>
            ...
            ></img>
            <label>Name</label>{" "}
            <input type="text" name="field1" value={element.name} />
            <label>location</label>
            <input type="email" name="field2" value={element.location} />
            <label>Description</label>
            <textarea name="field3" value={element.description}></textarea>
            <label>Area</label>
            <textarea name="field3" value={element.area}></textarea>
            <label>year</label>
            <textarea name="field3" value={element.year}></textarea>
            {/* <ExtraImgs {...element}></ExtraImgs> */}
          </fieldset>

          <fieldset>
            <legend>
              <span class="number">2</span> Additional Images
            </legend>
      ...
      <div class="form-style-5">
        <form>
          <fieldset>
            <legend>
              <span class="number">1</span> Update Info here
            </legend>
            <img
              src={encodeURI(
                "https://arabex-server.herokuapp.com/load_image/?img=" +
          ...
          <fieldset>
            <legend>
              <span class="number">2</span> Add more images
            </legend>
            <input
              type="file"
              name="file"
