...
class Villlas extends React.Component {
  ...
  async componentWillMount() {
    console.log("fdsfsfs", this.props.match);
        ...
        <div>
          <section class="row">
            {this.state.persons[0] ? (
              <div class="row">
                <img
                  class="col-12 col-md-8 imagesGrid wr"
                  style={{ paddingBottom: "20px" }}
                  src={encodeURI(
                    url2 +
                      `${this.state.persons[0].image}` +
                      "&&type=" +
                      `${this.state.persons[0].category_id}`
                  )}
                ></img>
                <div class="col">
                  <img
                    class="row imagesGrid wr"
                    src={encodeURI(
                      url2 +
                        `${this.state.persons[0].image}` +
                        "&&type=" +
